...
The [Project Desk example](../../hyperbricks-basics/README.md) combines the
...
[YAML Usage](../../../docs/YAML_USAGE.md); for field names, use [Reference](../../../docs/REFERENCE.md).
...
has the same components. See [CLI](../../../docs/HYPERBRICKS_CLI.md).
...
Both pages should change. See [imports and inheritance](../../../docs/YAML_USAGE.md#imports).
...
[Template Syntax](../../../docs/YAML_USAGE.md#template-syntax).
...
shell. See [Routing](../../../docs/ROUTING.md).
...
[MENU example](../docs/menu-htmx-demo.md).
...
[configuration-driven rail example](../docs/config-driven-section-rail.md)
...
replaced. See [native esbuild](../../../docs/ESBUILD.md).
...
[Goja Render](../../../docs/GOJA_RENDER.md).
...
The [optional API lesson](../../hyperbricks-basics/docs/advanced.md) adds a
...
`response.headers.HX-Trigger` is not conditional on upstream success. The lesson makes
...
The [optional plugin lesson](../../hyperbricks-basics/docs/advanced.md)
...
toolchain as the host. See [Plugins](../../../docs/PLUGINS.md).
...
[Route Guard](../../../docs/ROUTE_GUARD.md).
...
The existing [YAML patterns module](../README.md)
