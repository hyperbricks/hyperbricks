...
| [`hyperbricks-basics`](hyperbricks-basics/) | Learning application | **Tests** — [`test_hyperbricks_basics.py`](../scripts/test_hyperbricks_basics.py) | Project Desk, the main guided introduction to shared pages, fragments, templates, esbuild, `goja_render`, static delivery, APIs, guards, and plugins. |
