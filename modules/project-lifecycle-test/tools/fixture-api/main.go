// This local fixture API keeps one project in memory. Restarting resets it.
package main
	...
	mux.HandleFunc("GET /api/settings", func(w http.ResponseWriter, r *http.Request) {
		...
		if requireOwner(w, r) {
			writeJSON(w, http.StatusOK, map[string]any{
				...
				"visibility": "Private fixture project",
			})
		}
	})
...
func main() {
	...
	log.Printf("Project Lifecycle Fixture fixture API: http://%s (memory only; restart resets data)", address)
