...
type HTMLConfig struct {
	...
	MetaDocDescription string `mapstructure:"@doc" description:"Component for rendering raw HTML snippets." example:"{!{html-@doc.hyperbricks.yaml}}"`

	Value     string `mapstructure:"value" validate:"required" description:"The raw HTML content" example:"{!{html-value.hyperbricks.yaml}}"`
	TrimSpace bool   `mapstructure:"trimspace"  description:"TrimSpace filters all leading and trailing white space removed, as defined by Unicode." example:"{!{html-trimspace.hyperbricks.yaml}}"`
}
